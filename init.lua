...
require('lazy').setup({
  ...
  'tpope/vim-sleuth', -- Detect indentation and adjusts based on file
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gf', builtin.keymaps, { desc = '[G]it [F]iles' })
...

  {
    ...
    dependencies = {
      ...
      { 'folke/neodev.nvim', opts = {} }, -- completion, annotations and signatures of Neovim apis
    },
    config = function()
...

  {
    ...
    init = function()
      ...
      -- Removes any GUI-specific styles (like bold or italic) from comments,
      -- ensuring they are displayed with the default text style
